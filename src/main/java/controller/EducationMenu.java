...
public class EducationMenu {
    ...
    public Long showAddEducation() {
        ...
        educationService.createEducation(new Education(id, elematrySchool, secondrySchool,
                higherEducation));
        return id;
    }
    ...
    public Long showEditEducation() {
        ...
        higherEducation = sc.nextBoolean();
        educationService.editEducation(id, new Education(id, elematrySchool, secondrySchool,
                higherEducation));
        return id;
    }
